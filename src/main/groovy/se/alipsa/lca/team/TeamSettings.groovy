...
class TeamSettings {
  ...
  TeamSettings(
    ...
    @Value('${assistant.team.architect-model:${assistant.llm.model:qwen3.6-96k:latest}}') String architectModel,
    @Value('${assistant.team.engineer-model:${assistant.llm.model:qwen3.6-96k:latest}}') String engineerModel,
    @Value('${assistant.team.dispatcher-model:${assistant.llm.model:qwen3.6-96k:latest}}') String dispatcherModel,
